...
def _get_request(url):
    try:
        ...
        logger.warning('Failed connect to %s due to %s', url, e)
        raise external_api_exceptions.ExternalApiConnectionError
...
def get_random_word():
    ...
    if response.status_code != requests.codes.ok or not response.text:
        ...
        raise external_api_exceptions.ExternalApiFetchError
...
def get_wiki_article(word):
    ...
    try:
        ...
        raise external_api_exceptions.ExternalApiParseError
